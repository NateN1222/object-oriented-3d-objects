...
class object{
    public:
        /** Default constructor */
        object(char* objFile, glm::vec3 Pos,float scale,GLuint shaderProgram);
        object(obj modl, glm::vec3 Pos,float scale,GLuint shaderProgram);
        /** Default destructor */
        virtual ~object();
        /** Access objectCount
         ...
         * \param val New value to set
         */
        //void SetrotationAngle(glm::vec3 val) { rotationAngle = val; }
        ...
        void draw(float cum_x, float cum_y);
    ...
    private:
        ...
        obj model; // the data from the file
        bool spawned;
        GLuint vao;
        GLuint ebo;
        GLuint vbo;
